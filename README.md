...
- [Flowseal/tg-ws-proxy](https://github.com) — оригинальный проект и основная идея;
- [amurcanov/tg-ws-proxy-android](https://github.com) — Rust-ядро и Android-форк, используемые как upstream;
- [IMDelewer/tg-ws-proxy-ios](https://github.com) — оригинальная iOS-оболочка и интеграция Apple frameworks.
